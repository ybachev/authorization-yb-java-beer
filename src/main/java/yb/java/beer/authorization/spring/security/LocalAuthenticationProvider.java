...
public class LocalAuthenticationProvider implements AuthenticationProvider {
    ...
    @Autowired
    public LocalAuthenticationProvider(BCryptPasswordEncoder encoder, UserService userService) {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        User user = userService.getByUsername(userName).orElseThrow(() -> new UsernameNotFoundException("NO such user: " + userName));
